...
do
    ...
    ThemeManager.BuiltInThemes = {
        ...
        ["Crimson Void [NEW]"] = {
            19,
            httpService:JSONDecode(
                [[{"FontColor":"ffffff","MainColor":"1a0b0b","AccentColor":"ff3b3b","BackgroundColor":"120707","OutlineColor":"2e1b1b"}]]
            ),
        },
        ["Neon Wave [NEW]"] = {
            20,
            httpService:JSONDecode(
                [[{"FontColor":"e8e8e8","MainColor":"1b1030","AccentColor":"00ffff","BackgroundColor":"120a1f","OutlineColor":"32275a"}]]
            ),
        },
        ["Azure Dream [NEW]"] = {
            22,
